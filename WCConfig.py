...
class WCConfig:
    blenderPath: str = ""
    blenderArgs: str = ""
    outputPath: str = "" #TODO:set default value
    ...
    def __init__(self, blenderPath: str, blenderArgs: str, outputPath: str, serverAddress: str, httpHost: str, httpPort: int, autoRegister: bool):
